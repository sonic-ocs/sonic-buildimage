include $(PLATFORM_PATH)/ocs-libs-release.mk
...
# Inject ocs-kvm sai into syncd
$(SYNCD)_DEPENDS += $(OCS_KVM_LIBSAI_DEB) $(LIBSAIMETADATA_DEV)

# The platform (PMON) HAL driver is implemented natively in the sonic_platform
# python package (sonic-platform-modules-ocs-kvm/ocs-v/sonic_platform/hal.py),
